...
public class GranateEntity extends ProjectileItemEntity implements IRendersAsItem{

	public GranateEntity(EntityType<? extends PotionEntity> typeIn, World worldIn) {
		super(typeIn, worldIn);
	}

	public GranateEntity(World worldIn, LivingEntity livingEntityIn) {
		super(EntityType.SNOWBALL, livingEntityIn, worldIn);
	}

	public GranateEntity(World worldIn, double x, double y, double z) {
